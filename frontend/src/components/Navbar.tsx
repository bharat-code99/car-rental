...
export default function Navbar({setShowLogin}:NavbarProps){
  ...
  return(
    <nav className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-28 py-4 text-gray-600 boder-b
      ...
      <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 max-sm:border-t border-borderColor
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          <button onClick={() => setShowLogin(true)} className="cursor-pointer px-8 py-1.5 rounded-lg bg-primary text-white hover:bg-primary-dull
