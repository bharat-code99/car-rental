...
export default function Hero(){
  ...
  return(
    <div className="h-screen flex flex-col justify-center items-center gap-14 bg-light text-center md:pt-20">
      ...
      <form className="flex flex-col md:flex-row items-start md:items-center justify-between 
                        p-6 rounded-lg md:rounded-full w-full max-w-xs md:max-w-3xl
