          ...
          {cars.map((car, index) => (
            <tr key={index} className="border-t border-borderColor ">
              ...
              <td className="p-3 max-md:hidden">
                <span className={`px-2 py-0.5 rounded-full text-xs ${car.isAvaliable ? 'text-green-500 bg-green-100' : 'text-red-500 bg-red-100'}`}>{car.isAvaliable ? "Available" : "Unavailable"}</span>
              </td>
